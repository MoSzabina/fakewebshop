...
export default function Home() {
    ...
    return (
        <>
            ...
            <section className="mx-auto max-w-[1040px] px-8 py-[72px] rounded bg-parchment/70">
            ...
            <section>
                ...
                <div className="mb-5 rounded bg-parchment p-10">
                    <div className="mb-5 text-[11px] font-medium tracking-[0.12em] text-ink-mid">
                        PORTFOLIO PROJECT
                    </div>

                    <div className="mb-2 text-[52px] font-light leading-[1.08] tracking-[-0.03em] text-ink">
                        {__("A webshop,")}
                    </div>

                    <div className="mb-7 text-[52px] font-bold leading-[1.08] tracking-[-0.03em] text-ink">
                    ...
                    <div className="my-8 border-b border-rule" />
                    ...
                    <ul className="mb-5 list-disc pl-5 text-[15px] leading-[1.72] text-ink">
                        <li>Laravel</li>
                        <li>React</li>
                        <li>TypeScript</li>
                        <li>Inertia</li>
