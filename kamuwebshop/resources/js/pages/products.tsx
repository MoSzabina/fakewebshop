            ...
            <div className="mx-auto max-w-[1040px]">
                ...
                <div className="mb-8 flex flex-col gap-4 border-b border-rule pb-6 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <div>
                        <label
                            htmlFor="category"
                            className="mb-2 block text-[12px] font-medium text-ink-mid"
                        >
                            {__('Category')}
                        </label>
                        ...
                        <select
                            ...
                            className="rounded-[3px] border-[1.5px] border-rule bg-white px-3 py-2 text-[14px] text-ink outline-none focus:border-ink"
                        >
